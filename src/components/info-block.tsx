        ...
        {paket.map((el: InfoBlockElement, index: number) => {
          return (
            <div className="flex flex-col  gap-6 items-center" key={index}>
              <div
                className="flex items-center text-[26px] gap-6 cursor-pointer w-full lg:w-[814px] justify-between bg-[#f8f8f8] p-6"
              ...
              <div
                className={`${
                  open == el._uid
                    ? "lg:flex flex-col items-center lg:gap-8 lg:mt-4 lg:mb-4 w-[100%] lg:w-[70%]"
                    : "hidden"
                }`}
              >
